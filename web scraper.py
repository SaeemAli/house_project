...
url = 'https://www.rightmove.co.uk/property-for-sale/find.html?locationIdentifier=REGION%5E87490&maxPrice=1000000&sortType=6&propertyTypes=detached%2Csemi-detached%2Cterraced&includeSSTC=false&mustHave=&dontShow=&furnishTypes=&keywords='
rmd = RightmoveData(url)
df = rmd.get_results
#print(df.head())
df.to_csv('london.csv') # Enter csv file name
